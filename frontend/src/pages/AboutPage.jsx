    ...
    <FadeIn>
      ...
      <div className="grid lg:grid-cols-5 gap-8 items-stretch mb-12">
        <div className="lg:col-span-3 h-full">
          <AnimatedOfficeMap showDestinations legendInside fill title="Office & Trade-Flow Map" />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-12 items-stretch">
        ...
        {[
          ...
          { label: 'Destination Markets', color: '#0B3C5D', items: ['Tunisia', 'Algeria', 'Morocco', 'Libya', 'Egypt', 'Lebanon', 'Syria', 'Saudi Arabia', 'Pakistan', 'India', 'Nepal', 'Sri Lanka', 'Bangladesh', 'China', 'Thailand', 'Vietnam', 'Malaysia', 'Philippines', 'Indonesia'] },
        ].map((g) => (
