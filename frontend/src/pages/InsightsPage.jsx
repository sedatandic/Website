              ...
              <div className="flex flex-wrap gap-2 flex-1">
                {categories.map(cat => (
                  <Button
                    ...
                    style={
                      activeCategory === cat
                        ? { background: '#7B2FA0', color: 'white', border: 'none' }
                  ...
                  <Link to={`/insights/${item.slug || item.id}`}>
                    ...
                    >
                      ...
                      <CardContent className="p-5">
                        ...
                        <span className="mt-3 text-xs font-medium inline-flex items-center gap-1 group-hover:gap-2 transition-all" style={{ color: '#7B2FA0' }}>
