                  ...
                  <ul className="space-y-2">
                    {job.requirements.map((req, i) => (
                      <li key={i} className="flex items-start gap-2 text-sm" style={{ color: '#4b5563' }}>
                        <CheckCircle className="w-4 h-4 mt-0.5 flex-shrink-0" style={{ color: '#7B1E2F' }} />
                        {req}
                      </li>
                    ))}
                  </ul>
                  ...
                  {applied ? (
                    ...
                    <>
                      ...
                      <form onSubmit={handleApply} className="space-y-3">
                        ...
                        <Button type="submit" disabled={submitting} className="w-full rounded-full mt-2" style={{ background: '#7B1E2F', color: 'white' }} data-testid="careers-apply-submit-button">
