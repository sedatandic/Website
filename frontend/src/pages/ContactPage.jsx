        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <FadeIn delay={0.1} className="lg:col-span-4 flex flex-col h-full">
              <div className="rounded-xl overflow-hidden shadow-sm border relative flex-1" style={{ borderColor: '#e5e7eb', minHeight: '300px' }}>
                <img
              ...
              <div className="rounded-xl overflow-hidden shadow-sm border mt-4 flex-1" style={{ borderColor: '#e5e7eb', minHeight: '300px' }}>
                <iframe
